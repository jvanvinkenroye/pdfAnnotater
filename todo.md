...
- [ ] H-01: CSRF-Schutz fuer alle POST/DELETE Endpoints (Flask-WTF)
...
- [ ] M-01: DatabaseManager Singleton Thread-Safety
...
- [ ] M-08: Rate Limiting fuer Upload/Render Endpoints
...
- [ ] M-17: alert()/confirm() durch Modal/Toast-System ersetzen
- [x] M-18: Client-seitiges Image Caching + Cache Headers

## LOW Priority

- [ ] L-01: f-strings in Logging durch lazy evaluation ersetzen
- [x] L-02: Doppelte ruff-Config bereinigen
- [x] L-03: get_page_count Typ-Konsistenz (str vs Path)
- [ ] L-04: TestingConfig.DATABASE_PATH als Path
- [x] L-05: create_app Parameter-Typ str | None
- [x] L-06: Log-Rotation konfigurieren
- [ ] L-07: sys.path Hack in run_desktop.py entfernen
- [ ] L-08: Inline styles durch CSS-Klassen ersetzen
- [ ] L-09: Color Contrast fuer secondary text pruefen
- [ ] L-10: Flash Messages auto-dismiss + Close-Button
- [x] L-11: Year Input pattern/type Validierung
- [ ] L-12: Documents Table responsive fuer Mobile
